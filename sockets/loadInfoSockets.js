...
/**
 * Función para establecer la conexión del socket.
 * @param {object} io - Objeto del socket.io.
 */
export function socket(io) {
	/**
	 * Evento de conexión del socket.
	 * @param {object} socket - Objeto del socket.
	 */
	io.on("connection", (socket) => {
		/**
		 * Evento para cargar el archivo coin.
		 * @param {object} data - Datos del archivo.
		 * @param {string} data.file - Archivo coin a cargar.
		 */
		...
		/**
		 * Evento para cargar el archivo afil.
		 * @param {object} data - Datos del archivo.
		 * @param {string} data.file - Archivo afil a cargar.
		 */
		...
		/**
		 * Evento para cargar el archivo rale.
		 * @param {object} data - Datos del archivo.
		 * @param {string} data.file - Archivo rale a cargar.
		...
		// ! INSERT COIN PROCESS
		/**
		 * Evento para insertar los datos del archivo coin en la base de datos.
		 ...
		 * @param {Array} data.afil - Arreglo de objetos con los registros AFIL a insertar.
		 * @param {string} data.lote - Número de lote de los registros a insertar.
		...
		/**
		 * Maneja la inserción de registros RALE COP en la base de datos.
		 * @param {Object} data - Datos enviados por el cliente.
		 * @param {Array} data.rale - Arreglo de objetos con los registros RALE COP a insertar.
		 * @param {string} data.lote - Número de lote de los registros a insertar.
		 * @param {function} callback - Función de devolución de llamada para enviar una respuesta al cliente.
		 */
		socket.on(
		...
		/**
		 * Maneja la inserción de registros RALE RCV en la base de datos.
		 * @param {Object} data - Datos enviados por el cliente.
		 * @param {Array} data.rale - Arreglo de objetos con los registros RALE RCV a insertar.
		 * @param {string} data.lote - Número de lote de los registros a insertar.
		 * @param {function} callback - Función de devolución de llamada para enviar una respuesta al cliente.
		 */
		socket.on(
		...
		/**
		 * Maneja la consulta de las fechas de registro en la tabla Afil.
		 */
		...
		/**
		 * Maneja el filtrado de los registros Afil por fecha.
		 * @param {string} fechaAfil - Fecha en formato YYYY-MM-DD para filtrar los registros.
		 */
		...
		/**
		 * Maneja la consulta de las fechas de registro en la tabla Coin.
		 */
		...
		/**
		 * Maneja el filtrado de los registros Coin por fecha.
		 * @param {string} fechaCoin - Fecha en formato YYYY-MM-DD para filtrar los registros.
		 */
		...
		/**
		 * Maneja la consulta de las fechas de registro en la tabla Rale COP.
		 */
		...
		/**
		 * Maneja el filtrado de los registros Rale COP por fecha.
		 * @param {string} fechaRaleCOP - Fecha en formato YYYY-MM-DD para filtrar los registros.
		 */
		...
		/**
		 * Maneja la consulta de las fechas de registro en la tabla Rale RCV.
		 */
		...
		/**
		 * Maneja el filtrado de los registros Rale RCV por fecha.
		 * @param {string} fechaRaleRCV - Fecha en formato YYYY-MM-DD para filtrar los registros.
		 */
		...
		/**
		 * Maneja la consulta de las fechas de registro en una tabla específica.
		 * @param {string} valor - Valor que indica la tabla a consultar ("afil", "coin", "cop", "rcv").
		 */
		...
		/**
		 * Maneja el filtrado de los registros de una tabla por fecha.
		 * @param {string} fecha - Fecha en formato YYYY-MM-DD para filtrar los registros.
		 * @param {string} valor - Valor que indica la tabla a filtrar ("afil", "coin", "cop", "rcv").
		 */
...
/**
 * Procesa un archivo Coin y retorna los datos procesados como un arreglo de objetos.
 * @param {ArrayBuffer} file - Archivo Coin en formato de arreglo de bytes.
 * @returns {Array<Object>} - Arreglo de objetos con los datos procesados del archivo Coin.
 */
...
/**
 * Procesa un archivo Rale y retorna los datos procesados como un objeto que contiene el arreglo de objetos con los datos y el tipo de Rale.
 * @param {ArrayBuffer} file - Archivo Rale en formato de arreglo de bytes.
 * @returns {Object} - Objeto que contiene el arreglo de objetos con los datos procesados y el tipo de Rale.
 */
...
/**
 * Procesa un archivo Afil y retorna los datos procesados como un arreglo de objetos.
 * @param {ArrayBuffer} file - Archivo Afil en formato de arreglo de bytes.
 * @returns {Array<Object>} - Arreglo de objetos con los datos procesados del archivo Afil.
 */
