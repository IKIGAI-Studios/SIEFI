...
function fillStats() {
    ...
    $('#CUOTAS_pendiente').text(dataStats.filter(obj => obj.type === "cuotas" && !obj.cobrado).length)
    ...
    $('#CUOTAS_diligenciado').text(dataStats.filter(obj => obj.type === "cuotas" && obj.cobrado).length)
    ...
    $('#RCV_pendiente').text(dataStats.filter(obj => obj.type === "rcv" && !obj.cobrado).length)
    ...
    $('#RCV_diligenciado').text(dataStats.filter(obj => obj.type === "rcv" && obj.cobrado).length)
